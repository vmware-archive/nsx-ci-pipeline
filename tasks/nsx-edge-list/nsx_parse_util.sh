...
ISO_TILE_1_JOBS_LBR_MAP=( [tcp_router]="$ISOZONE_SWITCH_1_TCPROUTER_LBR_DETAILS" \
 [router]="$ISOZONE_SWITCH_1_GOROUTER_LBR_DETAILS" \
 [isolated_tcp_router]="$ISOZONE_SWITCH_1_TCPROUTER_LBR_DETAILS"  \
 [isolated_router]="$ISOZONE_SWITCH_1_GOROUTER_LBR_DETAILS" )

declare -A ISO_TILE_2_JOBS_LBR_MAP
ISO_TILE_2_JOBS_LBR_MAP=( [tcp_router]="$ISOZONE_SWITCH_2_TCPROUTER_LBR_DETAILS" \
 [router]="$ISOZONE_SWITCH_2_GOROUTER_LBR_DETAILS" \
 [isolated_tcp_router]="$ISOZONE_SWITCH_2_TCPROUTER_LBR_DETAILS"  \
 [isolated_router]="$ISOZONE_SWITCH_2_GOROUTER_LBR_DETAILS" )

declare -A ISO_TILE_3_JOBS_LBR_MAP
ISO_TILE_3_JOBS_LBR_MAP=( [tcp_router]="$ISOZONE_SWITCH_3_TCPROUTER_LBR_DETAILS" \
 [router]="$ISOZONE_SWITCH_3_GOROUTER_LBR_DETAILS" \
 [isolated_tcp_router]="$ISOZONE_SWITCH_3_TCPROUTER_LBR_DETAILS"  \
